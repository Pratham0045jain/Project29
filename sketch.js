...
function setup() {
  ...
  ground = new Ground(600,350,360,16);
  ...
  //leve3
  block12 = new Box(580,50,40,50,"green");
  block13 = new Box(620,50,40,50,"green");
  block14 = new Box(660,50,40,50,"green");

  //level4
  block15 = new Box(620,0,40,50,"yellow");
  ...
  shoot = new Hexagon(30,40,50,40,"orange");
